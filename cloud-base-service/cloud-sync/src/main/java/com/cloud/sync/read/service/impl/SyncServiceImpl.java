package com.cloud.sync.read.service.impl;

import com.alibaba.fastjson2.JSONArray;
import com.alibaba.fastjson2.JSONObject;
import com.cloud.sync.base.service.*;
import com.cloud.sync.read.builder.DateTimeConverter;
...
//                    System.out.println("record.value() =》 " + record.value());
    ...
    private Properties getProperties(Long serveId, ConnectConfigVo connectConfigVo, List<TableConfigVo> tableConfigVos) {
        if (Objects.equals(connectConfigVo.getType(), DataBaseType.MySql.getType())) {
            return getMysql(serveId, connectConfigVo, tableConfigVos);
        } else if (Objects.equals(connectConfigVo.getType(), DataBaseType.PostgreSQL.getType())) {

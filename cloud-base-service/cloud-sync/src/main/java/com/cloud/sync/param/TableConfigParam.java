...
public class TableConfigParam {
     ...
     * 数据库id
     */
    @NotNull(message = "数据库id[TableConfigVo.connectId]不能为null")
     ...
     * 数据库表
     */
    @Length(max = 100, message = "数据库表[TableConfigVo.tableName]长度不能超过100个字符")
     ...
     * 备注
     */
    @Length(max = 300, message = "备注[TableConfigVo.remark]长度不能超过300个字符")
